...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.wth.cloudstorage");// 自定义包的路径
...
//        strategyConfig.setTablePrefix("t_");
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("wth");
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/cloud_storage?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}